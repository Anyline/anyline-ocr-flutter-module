...
class ScanViewConfiguration {
    ...
    factory ScanViewConfiguration.fromRawJson(String str) => ScanViewConfiguration.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ScanViewConfiguration.fromJson(Map<String, dynamic> json) => ScanViewConfiguration(
        cameraConfig: json["cameraConfig"] == null ? null : CameraConfig.fromJson(json["cameraConfig"]),
        flashConfig: json["flashConfig"] == null ? null : FlashConfig.fromJson(json["flashConfig"]),
        options: json["options"] == null ? null : Map.from(json["options"]).map((k, v) => MapEntry<String, dynamic>(k, v)),
        scanViewConfigDescription: json["scanViewConfigDescription"],
        viewPluginCompositeConfig: json["viewPluginCompositeConfig"] == null ? null : ViewPluginCompositeConfig.fromJson(json["viewPluginCompositeConfig"]),
        viewPluginConfig: json["viewPluginConfig"] == null ? null : ViewPluginConfig.fromJson(json["viewPluginConfig"]),
    );
...
class CameraConfig {
    ...
    factory CameraConfig.fromRawJson(String str) => CameraConfig.fromJson(json.decode(str));
    ...
    factory CameraConfig.fromJson(Map<String, dynamic> json) => CameraConfig(
        ...
        fallbackCameras: json["fallbackCameras"] == null ? [] : List<String>.from(json["fallbackCameras"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "fallbackCameras": fallbackCameras == null ? [] : List<dynamic>.from(fallbackCameras!.map((x) => x)),
...
class ViewPluginCompositeConfig {
    ...
    factory ViewPluginCompositeConfig.fromJson(Map<String, dynamic> json) => ViewPluginCompositeConfig(
        id: json["id"],
        processingMode: processingModeValues.map[json["processingMode"]],
        viewPlugins: json["viewPlugins"] == null ? [] : List<ViewPlugin>.from(json["viewPlugins"]!.map((x) => ViewPlugin.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "id": id,
        "processingMode": processingModeValues.reverse[processingMode],
        "viewPlugins": viewPlugins == null ? [] : List<dynamic>.from(viewPlugins!.map((x) => x.toJson())),
    };
}
...
class ViewPluginConfig {
    ...
    factory ViewPluginConfig.fromJson(Map<String, dynamic> json) => ViewPluginConfig(
        cutoutConfig: json["cutoutConfig"] == null ? null : CutoutConfig.fromJson(json["cutoutConfig"]),
        pluginConfig: json["pluginConfig"] == null ? null : PluginConfig.fromJson(json["pluginConfig"]),
        scanFeedbackConfig: json["scanFeedbackConfig"] == null ? null : ScanFeedbackConfig.fromJson(json["scanFeedbackConfig"]),
        uiFeedbackConfig: json["uiFeedbackConfig"] == null ? null : UiFeedbackConfig.fromJson(json["uiFeedbackConfig"]),
    );
...
class NonNegativeOffset {
    ...
    factory NonNegativeOffset.fromRawJson(String str) => NonNegativeOffset.fromJson(json.decode(str));
...
class RatioFromSize {
    ...
    factory RatioFromSize.fromRawJson(String str) => RatioFromSize.fromJson(json.decode(str));
...
class PluginConfig {
    ...
    factory PluginConfig.fromRawJson(String str) => PluginConfig.fromJson(json.decode(str));
    ...
    Map<String, dynamic> toJson() => {
        ...
        "id": id,
        "japaneseLandingPermissionConfig": japaneseLandingPermissionConfig?.toJson(),
        ...
        "startVariables": startVariables == null ? [] : List<dynamic>.from(startVariables!.map((x) => x.toJson())),
        ...
        "vehicleRegistrationCertificateConfig": vehicleRegistrationCertificateConfig?.toJson(),
...
class BarcodeConfig {
    ...
    factory BarcodeConfig.fromJson(Map<String, dynamic> json) => BarcodeConfig(
        barcodeFormats: json["barcodeFormats"] == null ? [] : List<BarcodeFormat>.from(json["barcodeFormats"]!.map((x) => barcodeFormatValues.map[x]!)),
    ...
    Map<String, dynamic> toJson() => {
        "barcodeFormats": barcodeFormats == null ? [] : List<dynamic>.from(barcodeFormats!.map((x) => barcodeFormatValues.reverse[x])),
...
class CommercialTireIdConfig {
    ...
    factory CommercialTireIdConfig.fromRawJson(String str) => CommercialTireIdConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory CommercialTireIdConfig.fromJson(Map<String, dynamic> json) => CommercialTireIdConfig(
...
class ContainerConfig {
    ...
    factory ContainerConfig.fromRawJson(String str) => ContainerConfig.fromJson(json.decode(str));
...
class JapaneseLandingPermissionConfig {
    ...
    factory JapaneseLandingPermissionConfig.fromRawJson(String str) => JapaneseLandingPermissionConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory JapaneseLandingPermissionConfig.fromJson(Map<String, dynamic> json) => JapaneseLandingPermissionConfig(
        airport: json["airport"] == null ? null : JapaneseLandingPermissionConfigFieldOption.fromJson(json["airport"]),
        dateOfExpiry: json["dateOfExpiry"] == null ? null : JapaneseLandingPermissionConfigFieldOption.fromJson(json["dateOfExpiry"]),
        dateOfIssue: json["dateOfIssue"] == null ? null : JapaneseLandingPermissionConfigFieldOption.fromJson(json["dateOfIssue"]),
        duration: json["duration"] == null ? null : JapaneseLandingPermissionConfigFieldOption.fromJson(json["duration"]),
        status: json["status"] == null ? null : JapaneseLandingPermissionConfigFieldOption.fromJson(json["status"]),
    );
...
class JapaneseLandingPermissionConfigFieldOption {
    ...
    factory JapaneseLandingPermissionConfigFieldOption.fromRawJson(String str) => JapaneseLandingPermissionConfigFieldOption.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory JapaneseLandingPermissionConfigFieldOption.fromJson(Map<String, dynamic> json) => JapaneseLandingPermissionConfigFieldOption(
        minConfidence: json["minConfidence"],
...
class LicensePlateConfig {
    ...
    factory LicensePlateConfig.fromJson(Map<String, dynamic> json) => LicensePlateConfig(
        minConfidence: json["minConfidence"],
        scanMode: licensePlateConfigScanModeValues.map[json["scanMode"]],
        validationRegex: json["validationRegex"],
        vehicleInspectionSticker: vehicleInspectionStickerValues.map[json["vehicleInspectionSticker"]],
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "validationRegex": validationRegex,
        "vehicleInspectionSticker": vehicleInspectionStickerValues.reverse[vehicleInspectionSticker],
    };
}
...
final meterConfigScanModeValues = EnumValues({
    ...
    "digital_meter_2_experimental": MeterConfigScanMode.DIGITAL_METER_2_EXPERIMENTAL,
...
class MrzConfig {
    ...
    factory MrzConfig.fromRawJson(String str) => MrzConfig.fromJson(json.decode(str));
    ...
    factory MrzConfig.fromJson(Map<String, dynamic> json) => MrzConfig(
        ...
        minConfidence: json["minConfidence"],
        mrzFieldScanOptions: json["mrzFieldScanOptions"] == null ? null : MrzFieldScanOptions.fromJson(json["mrzFieldScanOptions"]),
        mrzMinFieldConfidences: json["mrzMinFieldConfidences"] == null ? null : MrzMinFieldConfidences.fromJson(json["mrzMinFieldConfidences"]),
...
class MrzFieldScanOptions {
    ...
    factory MrzFieldScanOptions.fromRawJson(String str) => MrzFieldScanOptions.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory MrzFieldScanOptions.fromJson(Map<String, dynamic> json) => MrzFieldScanOptions(
        checkDigitDateOfBirth: mrzScanOptionValues.map[json["checkDigitDateOfBirth"]],
        checkDigitDateOfExpiry: mrzScanOptionValues.map[json["checkDigitDateOfExpiry"]],
        checkDigitDocumentNumber: mrzScanOptionValues.map[json["checkDigitDocumentNumber"]],
        checkDigitFinal: mrzScanOptionValues.map[json["checkDigitFinal"]],
        checkDigitPersonalNumber: mrzScanOptionValues.map[json["checkDigitPersonalNumber"]],
        ...
        nationalityCountryCode: mrzScanOptionValues.map[json["nationalityCountryCode"]],
    ...
    Map<String, dynamic> toJson() => {
        "checkDigitDateOfBirth": mrzScanOptionValues.reverse[checkDigitDateOfBirth],
        "checkDigitDateOfExpiry": mrzScanOptionValues.reverse[checkDigitDateOfExpiry],
        "checkDigitDocumentNumber": mrzScanOptionValues.reverse[checkDigitDocumentNumber],
        "checkDigitFinal": mrzScanOptionValues.reverse[checkDigitFinal],
        "checkDigitPersonalNumber": mrzScanOptionValues.reverse[checkDigitPersonalNumber],
        ...
        "nationalityCountryCode": mrzScanOptionValues.reverse[nationalityCountryCode],
...
class MrzMinFieldConfidences {
    ...
    factory MrzMinFieldConfidences.fromRawJson(String str) => MrzMinFieldConfidences.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory MrzMinFieldConfidences.fromJson(Map<String, dynamic> json) => MrzMinFieldConfidences(
...
class OcrConfig {
    ...
    factory OcrConfig.fromRawJson(String str) => OcrConfig.fromJson(json.decode(str));
...
class OdometerConfig {
    ...
    factory OdometerConfig.fromRawJson(String str) => OdometerConfig.fromJson(json.decode(str));
...
class TinConfig {
    ...
    factory TinConfig.fromRawJson(String str) => TinConfig.fromJson(json.decode(str));
...
///Sets the mode to scan universal TIN numbers ('UNIVERSAL') or TIN numbers of any length
///starting with DOT ('DOT').
enum TinConfigScanMode {
    DOT,
    UNIVERSAL
}

final tinConfigScanModeValues = EnumValues({
    "DOT": TinConfigScanMode.DOT,
    "UNIVERSAL": TinConfigScanMode.UNIVERSAL
});
...
class TireSizeConfig {
    ...
    factory TireSizeConfig.fromRawJson(String str) => TireSizeConfig.fromJson(json.decode(str));
...
class UniversalIdConfig {
    ...
    factory UniversalIdConfig.fromRawJson(String str) => UniversalIdConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UniversalIdConfig.fromJson(Map<String, dynamic> json) => UniversalIdConfig(
        allowedLayouts: json["allowedLayouts"] == null ? null : AllowedLayouts.fromJson(json["allowedLayouts"]),
        alphabet: alphabetValues.map[json["alphabet"]],
        drivingLicense: json["drivingLicense"] == null ? null : LayoutDrivingLicense.fromJson(json["drivingLicense"]),
        faceDetectionEnabled: json["faceDetectionEnabled"],
        idFront: json["idFront"] == null ? null : LayoutIdFront.fromJson(json["idFront"]),
        insuranceCard: json["insuranceCard"] == null ? null : LayoutInsuranceCard.fromJson(json["insuranceCard"]),
...
class AllowedLayouts {
    ...
    factory AllowedLayouts.fromRawJson(String str) => AllowedLayouts.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory AllowedLayouts.fromJson(Map<String, dynamic> json) => AllowedLayouts(
        drivingLicense: json["drivingLicense"] == null ? [] : List<String>.from(json["drivingLicense"]!.map((x) => x)),
        idFront: json["idFront"] == null ? [] : List<String>.from(json["idFront"]!.map((x) => x)),
        insuranceCard: json["insuranceCard"] == null ? [] : List<String>.from(json["insuranceCard"]!.map((x) => x)),
        mrz: json["mrz"] == null ? [] : List<String>.from(json["mrz"]!.map((x) => x)),
    );

    Map<String, dynamic> toJson() => {
        "drivingLicense": drivingLicense == null ? [] : List<dynamic>.from(drivingLicense!.map((x) => x)),
        "idFront": idFront == null ? [] : List<dynamic>.from(idFront!.map((x) => x)),
        "insuranceCard": insuranceCard == null ? [] : List<dynamic>.from(insuranceCard!.map((x) => x)),
...
class LayoutDrivingLicense {
    ...
    factory LayoutDrivingLicense.fromJson(Map<String, dynamic> json) => LayoutDrivingLicense(
        ...
        audit: json["audit"] == null ? null : UniversalIdField.fromJson(json["audit"]),
        authority: json["authority"] == null ? null : UniversalIdField.fromJson(json["authority"]),
        cardNumber: json["cardNumber"] == null ? null : UniversalIdField.fromJson(json["cardNumber"]),
        categories: json["categories"] == null ? null : UniversalIdField.fromJson(json["categories"]),
        conditions: json["conditions"] == null ? null : UniversalIdField.fromJson(json["conditions"]),
        ...
        documentDiscriminator: json["documentDiscriminator"] == null ? null : UniversalIdField.fromJson(json["documentDiscriminator"]),
        documentNumber: json["documentNumber"] == null ? null : UniversalIdField.fromJson(json["documentNumber"]),
        duplicate: json["duplicate"] == null ? null : UniversalIdField.fromJson(json["duplicate"]),
        duration: json["duration"] == null ? null : UniversalIdField.fromJson(json["duration"]),
        endorsements: json["endorsements"] == null ? null : UniversalIdField.fromJson(json["endorsements"]),
        eyes: json["eyes"] == null ? null : UniversalIdField.fromJson(json["eyes"]),
        firstIssued: json["firstIssued"] == null ? null : UniversalIdField.fromJson(json["firstIssued"]),
        ...
        hair: json["hair"] == null ? null : UniversalIdField.fromJson(json["hair"]),
        ...
        licenceNumber: json["licenceNumber"] == null ? null : UniversalIdField.fromJson(json["licenceNumber"]),
        licenseClass: json["licenseClass"] == null ? null : UniversalIdField.fromJson(json["licenseClass"]),
        licenseNumber: json["licenseNumber"] == null ? null : UniversalIdField.fromJson(json["licenseNumber"]),
        name: json["name"] == null ? null : UniversalIdField.fromJson(json["name"]),
        office: json["office"] == null ? null : UniversalIdField.fromJson(json["office"]),
        parish: json["parish"] == null ? null : UniversalIdField.fromJson(json["parish"]),
        ...
        previousType: json["previousType"] == null ? null : UniversalIdField.fromJson(json["previousType"]),
        restrictions: json["restrictions"] == null ? null : UniversalIdField.fromJson(json["restrictions"]),
        revoked: json["revoked"] == null ? null : UniversalIdField.fromJson(json["revoked"]),
        ...
        type: json["type"] == null ? null : UniversalIdField.fromJson(json["type"]),
        version: json["version"] == null ? null : UniversalIdField.fromJson(json["version"]),
        verticalNumber: json["verticalNumber"] == null ? null : UniversalIdField.fromJson(json["verticalNumber"]),
        weight: json["weight"] == null ? null : UniversalIdField.fromJson(json["weight"]),
    );
...
class UniversalIdField {
    ...
    factory UniversalIdField.fromRawJson(String str) => UniversalIdField.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UniversalIdField.fromJson(Map<String, dynamic> json) => UniversalIdField(
        minConfidence: json["minConfidence"],
        scanOption: mrzScanOptionValues.map[json["scanOption"]],
    );
...
class LayoutInsuranceCard {
    ...
    factory LayoutInsuranceCard.fromJson(Map<String, dynamic> json) => LayoutInsuranceCard(
        authority: json["authority"] == null ? null : UniversalIdField.fromJson(json["authority"]),
        dateOfBirth: json["dateOfBirth"] == null ? null : UniversalIdField.fromJson(json["dateOfBirth"]),
        dateOfExpiry: json["dateOfExpiry"] == null ? null : UniversalIdField.fromJson(json["dateOfExpiry"]),
        documentNumber: json["documentNumber"] == null ? null : UniversalIdField.fromJson(json["documentNumber"]),
...
class LayoutMrz {
    ...
    factory LayoutMrz.fromRawJson(String str) => LayoutMrz.fromJson(json.decode(str));
    ...
    factory LayoutMrz.fromJson(Map<String, dynamic> json) => LayoutMrz(
        dateOfBirth: json["dateOfBirth"] == null ? null : UniversalIdField.fromJson(json["dateOfBirth"]),
        dateOfExpiry: json["dateOfExpiry"] == null ? null : UniversalIdField.fromJson(json["dateOfExpiry"]),
        vizAddress: json["vizAddress"] == null ? null : UniversalIdField.fromJson(json["vizAddress"]),
        vizDateOfBirth: json["vizDateOfBirth"] == null ? null : UniversalIdField.fromJson(json["vizDateOfBirth"]),
        vizDateOfExpiry: json["vizDateOfExpiry"] == null ? null : UniversalIdField.fromJson(json["vizDateOfExpiry"]),
        vizDateOfIssue: json["vizDateOfIssue"] == null ? null : UniversalIdField.fromJson(json["vizDateOfIssue"]),
        vizGivenNames: json["vizGivenNames"] == null ? null : UniversalIdField.fromJson(json["vizGivenNames"]),
        vizSurname: json["vizSurname"] == null ? null : UniversalIdField.fromJson(json["vizSurname"]),
    );
...
class VehicleRegistrationCertificateConfig {
    ...
    factory VehicleRegistrationCertificateConfig.fromRawJson(String str) => VehicleRegistrationCertificateConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory VehicleRegistrationCertificateConfig.fromJson(Map<String, dynamic> json) => VehicleRegistrationCertificateConfig(
        vehicleRegistrationCertificate: json["vehicleRegistrationCertificate"] == null ? null : LayoutVehicleRegistrationCertificate.fromJson(json["vehicleRegistrationCertificate"]),
    );

    Map<String, dynamic> toJson() => {
        "vehicleRegistrationCertificate": vehicleRegistrationCertificate?.toJson(),
    };
}
...
class LayoutVehicleRegistrationCertificate {
    ...
    factory LayoutVehicleRegistrationCertificate.fromRawJson(String str) => LayoutVehicleRegistrationCertificate.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory LayoutVehicleRegistrationCertificate.fromJson(Map<String, dynamic> json) => LayoutVehicleRegistrationCertificate(
        address: json["address"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["address"]),
        brand: json["brand"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["brand"]),
        displacement: json["displacement"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["displacement"]),
        documentNumber: json["documentNumber"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["documentNumber"]),
        firstIssued: json["firstIssued"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["firstIssued"]),
        firstName: json["firstName"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["firstName"]),
        lastName: json["lastName"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["lastName"]),
        licensePlate: json["licensePlate"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["licensePlate"]),
        manufacturerCode: json["manufacturerCode"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["manufacturerCode"]),
        tire: json["tire"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["tire"]),
        vehicleIdentificationNumber: json["vehicleIdentificationNumber"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["vehicleIdentificationNumber"]),
        vehicleType: json["vehicleType"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["vehicleType"]),
        vehicleTypeCode: json["vehicleTypeCode"] == null ? null : VehicleRegistrationCertificateField.fromJson(json["vehicleTypeCode"]),
    );
...
class VehicleRegistrationCertificateField {
    ...
    factory VehicleRegistrationCertificateField.fromRawJson(String str) => VehicleRegistrationCertificateField.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory VehicleRegistrationCertificateField.fromJson(Map<String, dynamic> json) => VehicleRegistrationCertificateField(
        minConfidence: json["minConfidence"],
        scanOption: mrzScanOptionValues.map[json["scanOption"]],
    );
...
class VinConfig {
    ...
    factory VinConfig.fromRawJson(String str) => VinConfig.fromJson(json.decode(str));
...
class ScanFeedbackConfig {
    ...
    factory ScanFeedbackConfig.fromRawJson(String str) => ScanFeedbackConfig.fromJson(json.decode(str));
...
class UiFeedbackConfig {
    ...
    factory UiFeedbackConfig.fromRawJson(String str) => UiFeedbackConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackConfig.fromJson(Map<String, dynamic> json) => UiFeedbackConfig(
        elements: json["elements"] == null ? [] : List<UiFeedbackElementConfig>.from(json["elements"]!.map((x) => UiFeedbackElementConfig.fromJson(x))),
        presetDefinitions: json["presetDefinitions"] == null ? [] : List<UiFeedbackPresetDefinitionConfig>.from(json["presetDefinitions"]!.map((x) => UiFeedbackPresetDefinitionConfig.fromJson(x))),
        presets: json["presets"] == null ? [] : List<UiFeedbackPresetConfig>.from(json["presets"]!.map((x) => UiFeedbackPresetConfig.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "elements": elements == null ? [] : List<dynamic>.from(elements!.map((x) => x.toJson())),
        "presetDefinitions": presetDefinitions == null ? [] : List<dynamic>.from(presetDefinitions!.map((x) => x.toJson())),
...
class UiFeedbackElementConfig {
    ...
    factory UiFeedbackElementConfig.fromJson(Map<String, dynamic> json) => UiFeedbackElementConfig(
        clickable: json["clickable"],
        contentType: contentTypeEnumValues.map[json["contentType"]],
        defaultAttributes: json["defaultAttributes"] == null ? null : UiFeedbackElementAttributesConfig.fromJson(json["defaultAttributes"]),
        defaultContent: json["defaultContent"] == null ? null : UiFeedbackElementContentConfig.fromJson(json["defaultContent"]),
        id: json["id"],
        overlay: json["overlay"] == null ? null : OverlayConfig.fromJson(json["overlay"]),
        presets: json["presets"] == null ? [] : List<UiFeedbackPresetConfig>.from(json["presets"]!.map((x) => UiFeedbackPresetConfig.fromJson(x))),
        tag: json["tag"],
        trigger: json["trigger"] == null ? null : UiFeedbackElementTriggerConfig.fromJson(json["trigger"]),
    );
...
class UiFeedbackElementAttributesConfig {
    ...
    factory UiFeedbackElementAttributesConfig.fromJson(Map<String, dynamic> json) => UiFeedbackElementAttributesConfig(
...
class OverlayConfig {
    ...
    factory OverlayConfig.fromRawJson(String str) => OverlayConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory OverlayConfig.fromJson(Map<String, dynamic> json) => OverlayConfig(
        anchor: overlayAnchorConfigValues.map[json["anchor"]],
        offsetDimension: json["offsetDimension"] == null ? null : OverlayDimensionConfig.fromJson(json["offsetDimension"]),
        presets: json["presets"] == null ? [] : List<UiFeedbackPresetConfig>.from(json["presets"]!.map((x) => UiFeedbackPresetConfig.fromJson(x))),
        sizeDimension: json["sizeDimension"] == null ? null : OverlayDimensionConfig.fromJson(json["sizeDimension"]),
...
class OverlayDimensionConfig {
    ...
    factory OverlayDimensionConfig.fromRawJson(String str) => OverlayDimensionConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory OverlayDimensionConfig.fromJson(Map<String, dynamic> json) => OverlayDimensionConfig(
        scaleX: json["scaleX"] == null ? null : OverlayScaleConfig.fromJson(json["scaleX"]),
        scaleY: json["scaleY"] == null ? null : OverlayScaleConfig.fromJson(json["scaleY"]),
    );
...
class OverlayScaleConfig {
    ...
    factory OverlayScaleConfig.fromRawJson(String str) => OverlayScaleConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory OverlayScaleConfig.fromJson(Map<String, dynamic> json) => OverlayScaleConfig(
...
class UiFeedbackPresetConfig {
    ...
    factory UiFeedbackPresetConfig.fromRawJson(String str) => UiFeedbackPresetConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackPresetConfig.fromJson(Map<String, dynamic> json) => UiFeedbackPresetConfig(
        presetAttributes: json["presetAttributes"] == null ? [] : List<UiFeedbackPresetAttributeConfig>.from(json["presetAttributes"]!.map((x) => UiFeedbackPresetAttributeConfig.fromJson(x))),
        presetName: json["presetName"],
    );

    Map<String, dynamic> toJson() => {
        "presetAttributes": presetAttributes == null ? [] : List<dynamic>.from(presetAttributes!.map((x) => x.toJson())),
...
class UiFeedbackPresetAttributeConfig {
    ...
    factory UiFeedbackPresetAttributeConfig.fromRawJson(String str) => UiFeedbackPresetAttributeConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackPresetAttributeConfig.fromJson(Map<String, dynamic> json) => UiFeedbackPresetAttributeConfig(
...
final overlaySourceValues = EnumValues({
    "cutout": OverlaySource.CUTOUT
});
...
class UiFeedbackElementTriggerConfig {
    ...
    factory UiFeedbackElementTriggerConfig.fromRawJson(String str) => UiFeedbackElementTriggerConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackElementTriggerConfig.fromJson(Map<String, dynamic> json) => UiFeedbackElementTriggerConfig(
        presets: json["presets"] == null ? [] : List<UiFeedbackPresetConfig>.from(json["presets"]!.map((x) => UiFeedbackPresetConfig.fromJson(x))),
        runSkipped: json["runSkipped"] == null ? [] : List<UiFeedbackElementTriggerWhenRunSkippedConfig>.from(json["runSkipped"]!.map((x) => UiFeedbackElementTriggerWhenRunSkippedConfig.fromJson(x))),
        scanInfo: json["scanInfo"] == null ? [] : List<UiFeedbackElementTriggerWhenScanInfoConfig>.from(json["scanInfo"]!.map((x) => UiFeedbackElementTriggerWhenScanInfoConfig.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "presets": presets == null ? [] : List<dynamic>.from(presets!.map((x) => x.toJson())),
        "runSkipped": runSkipped == null ? [] : List<dynamic>.from(runSkipped!.map((x) => x.toJson())),
        "scanInfo": scanInfo == null ? [] : List<dynamic>.from(scanInfo!.map((x) => x.toJson())),
    };
}
...
class UiFeedbackElementTriggerWhenRunSkippedConfig {
    ...
    factory UiFeedbackElementTriggerWhenRunSkippedConfig.fromRawJson(String str) => UiFeedbackElementTriggerWhenRunSkippedConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackElementTriggerWhenRunSkippedConfig.fromJson(Map<String, dynamic> json) => UiFeedbackElementTriggerWhenRunSkippedConfig(
        when: json["when"] == null ? null : RunSkippedWhen.fromJson(json["when"]),
    );
...
class RunSkippedWhen {
    ...
    factory RunSkippedWhen.fromRawJson(String str) => RunSkippedWhen.fromJson(json.decode(str));
...
class UiFeedbackElementTriggerWhenScanInfoConfig {
    ...
    factory UiFeedbackElementTriggerWhenScanInfoConfig.fromRawJson(String str) => UiFeedbackElementTriggerWhenScanInfoConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackElementTriggerWhenScanInfoConfig.fromJson(Map<String, dynamic> json) => UiFeedbackElementTriggerWhenScanInfoConfig(
...
class UiFeedbackPresetDefinitionConfig {
    ...
    factory UiFeedbackPresetDefinitionConfig.fromRawJson(String str) => UiFeedbackPresetDefinitionConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackPresetDefinitionConfig.fromJson(Map<String, dynamic> json) => UiFeedbackPresetDefinitionConfig(
        attributes: json["attributes"] == null ? [] : List<UiFeedbackPresetDefinitionAttributeConfig>.from(json["attributes"]!.map((x) => UiFeedbackPresetDefinitionAttributeConfig.fromJson(x))),
        name: json["name"],
        presetContent: json["presetContent"] == null ? null : UiFeedbackPresetContentConfig.fromJson(json["presetContent"]),
...
class UiFeedbackPresetDefinitionAttributeConfig {
    ...
    factory UiFeedbackPresetDefinitionAttributeConfig.fromRawJson(String str) => UiFeedbackPresetDefinitionAttributeConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackPresetDefinitionAttributeConfig.fromJson(Map<String, dynamic> json) => UiFeedbackPresetDefinitionAttributeConfig(
...
class UiFeedbackPresetContentConfig {
    ...
    factory UiFeedbackPresetContentConfig.fromRawJson(String str) => UiFeedbackPresetContentConfig.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UiFeedbackPresetContentConfig.fromJson(Map<String, dynamic> json) => UiFeedbackPresetContentConfig(
        element: json["element"] == null ? null : UiFeedbackElementConfig.fromJson(json["element"]),
        elements: json["elements"] == null ? [] : List<UiFeedbackElementConfig>.from(json["elements"]!.map((x) => UiFeedbackElementConfig.fromJson(x))),
        overlay: json["overlay"] == null ? null : OverlayConfig.fromJson(json["overlay"]),
        presets: json["presets"] == null ? [] : List<UiFeedbackPresetConfig>.from(json["presets"]!.map((x) => UiFeedbackPresetConfig.fromJson(x))),
        trigger: json["trigger"] == null ? null : UiFeedbackElementTriggerConfig.fromJson(json["trigger"]),
