...
class AnylineServiceImpl implements AnylineService {
  ...
  Future<void> _initAnylinePlugin() async {
    ...
    anylinePlugin.setCustomModelsPath('flutter_assets/anyline_assets');
    anylinePlugin.setViewConfigsPath('flutter_assets/anyline_assets/config/legacy');
  }
  ...
  Future<String> _loadJsonConfigFromFile(String config) async {
    return rootBundle.loadString('anyline_assets/config/legacy/${config}Config.json');
  }
